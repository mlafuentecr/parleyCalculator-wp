...
function boc_stylesheet()
{
    ...
    echo "<link href='" . get_template_directory_uri() . "/calculator/bettingOddsConverter/boc.css?v=4.4' rel='stylesheet' type='text/css'>";
    echo "<script defer  src='" . get_template_directory_uri() . "/calculator/bettingOddsConverter/boc.js?v=4.4'></script>";
}
